...
export function Modal({onSubmit}){
  ...
  return(
      ...
      <form action="" onSubmit={onSubmit}>
          ...
          <ButtonBack/>
          <input name='title' className='text-2xl pl-5 text-secondary-foreground text-start border-none bg-transparent focus:outline-none' type='title' placeholder='Title...'
          id='title'/>
          </header>
          <main className='flex flex-col h-full w-full '>
            <div className='w-full p-5'>
                ...
                placeholder='Content...' name='content' id='content' type='content'/>
            </div>
          </main>
      </form>
      </div>
