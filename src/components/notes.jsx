  ...
  , [notes]);
    ...
    return (
      <div className='relative flex w-full h-full'>
        <button onClick={toggleNotesPage} className='z-10 bg-input shadow-md shadow-black text-foreground p-1 rounded-r-lg text-sm hover:bg-primary
          hover:text-primary-foreground duration-150 hover:extend'>
